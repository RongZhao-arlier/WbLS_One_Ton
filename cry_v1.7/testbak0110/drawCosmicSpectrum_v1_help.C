#include <stdio>
#include <string>
void drawCosmicSpectrum_v1_help(){
    ...
    TFile* myrootfile = new TFile("20170724/cosmic_muons_only_3MEvts_box30m_onlyHitCD_2_6mRange.root","recreate"); //cosmic_muons_only_5MEvts
