#include <stdio>
#include <string>
void drawCosmicSpectrum_v1_help1(){
    ...
    TFile* myrootfile = new TFile("20170724/cosmic_muons_only_3MEvts_box30m_onlyHitCD_2_4mRange.root","recreate"); //cosmic_muons_only_5MEvts
