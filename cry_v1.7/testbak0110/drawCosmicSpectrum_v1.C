#include <stdio>
#include <string>
void drawCosmicSpectrum_v1(){
    fstream fin("cosmic_muons_only_3MEvts_box30m_onlyHitCD_2.dat",ios::in);
    string secondary;
    int id;
    string name;
    float ke, x, y, z;
    ...
    TFile* myrootfile = new TFile("20170724/cosmic_muons_only_3MEvts_box30m_onlyHitCD_2_8mRange.root","recreate"); //cosmic_muons_only_5MEvts
